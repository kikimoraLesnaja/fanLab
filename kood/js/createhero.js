var heroSex = document.querySelector('input[name = "heroSex"]:checked').value;
		...
		function buttonClicked()
		{
			...
			document.getElementById("avatar1").src = "../view/img/heroes/"+ heroSex + "/1.png";
			document.getElementById("avatar2").src = "../view/img/heroes/"+ heroSex + "/2.png";
		...
		function button3Clicked()
		{
			...
			var imgsrc = "../view/img/heroes/"+ heroSex +"/" + heroAvatar +".png";
